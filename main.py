...
def main():
    parser = argparse.ArgumentParser(
        description="Convert epub to speech using Kyutai TTS",
        add_help=False
    )
    ...
    parser.add_argument("--reselect-chapters", action="store_true",
                       help="Force interactive chapter selection even if previous selection exists")
    parser.add_argument("--device", default="auto",
                       help="Device to use (cuda/cpu, default: auto-detect)")
    parser.add_argument("--max-chunk-words", type=int, default=DEFAULT_CHUNK_WORDS,
